...
const OrdersPaymentsFilters = ({
  ...
  return (
  <div className="filters-card filters-card--payments">
    <div className="filters-row-inline">
      ...
      <div className="filter-group">
        ...
        <select
          ...
          onChange={(e) => onChange({ ...v, amountDescription: e.target.value })}
        >
      ...
      {/* Actions */}
      <div className="filters-actions filters-actions--payments">
